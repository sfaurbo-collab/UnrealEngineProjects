...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFPPlayerController_Statics::NewProp_MovementContext = { "MovementContext", nullptr, (EPropertyFlags)0x0124080000000015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFPPlayerController, MovementContext), Z_Construct_UClass_UInputMappingContext_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MovementContext_MetaData), NewProp_MovementContext_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFPPlayerController_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFPPlayerController_Statics::NewProp_MovementContext,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_UnrealEngineProjects_FirstProject_CRPTD_Source_FirstProject_Public_Core_FPPlayerController_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AFPPlayerController, AFPPlayerController::StaticClass, TEXT("AFPPlayerController"), &Z_Registration_Info_UClass_AFPPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFPPlayerController), 1550891486U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealEngineProjects_FirstProject_CRPTD_Source_FirstProject_Public_Core_FPPlayerController_h_365844394(TEXT("/Script/FirstProject"),
	Z_CompiledInDeferFile_FID_UnrealEngineProjects_FirstProject_CRPTD_Source_FirstProject_Public_Core_FPPlayerController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealEngineProjects_FirstProject_CRPTD_Source_FirstProject_Public_Core_FPPlayerController_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
